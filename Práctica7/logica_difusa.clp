...
;b) añadiendo una variable de entrada nueva (por ejemplo la edad), y 
...
(variable peso)
(variable dosis)
(variable edad)     ;añado la nueva variable: la edad
)
...
(cd edad joven 0 10 15 30)      ; aproximadamente 15
(cd edad media 31 35 40 49)     ; aproximadamente 40
(cd edad mayor 50 60 80 80)     ; aproximadamente 65
)
...
(regla 5 explicacion "Si la edad es de persona joven, la dosis a aplicar es baja")
(regla 6 antecedente edad mayor)
(regla 6 consecuente dosis alta)
(regla 6 explicacion "Si la edad es de persona mayor, la dosis a aplicar es alta")
)
...
;Se añade la pregunta sobre la edad
(defrule pregunta3.1
(declare (salience 1))
=>
(printout t "Edad: ")
